            ...
            <ul class="taps_conbox" id="taps_conbox">
               ...
               <li class="taps_con">  
	                <div class="bar_tabbox" id="bar_tabbox">
	                 ...
	                 <p style="font-size:16px;float:left;margin-left:5%;margin-top:85px;background-color:#CAE1FF;">起始日期:&nbsp<input style="width:80px;margin-right:30px" type="text" id="datepicker1">
	                 截止日期:&nbsp<input style="width:80px" type="text" id="datepicker2">
	                  </p>
                   ...
                   <div class="bar_tabbox" style="margin-top:105px" id="bar_tabbox">
	                  ...
	                  <p style="font-size:16px;float:left;margin-left:5%;margin-top:48px;background-color:#CAE1FF">起始日期:&nbsp<input style="width:80px;margin-right:30px" type="text" id="datepicker3">
	                 截止日期:&nbsp<input style="width:80px" type="text" id="datepicker4">
	                  </p>
                ...
                <li class="taps_con">
                <div class="settings" id="settings"><input style="background-color:#00CC66;height:40px;margin:10px 20px 10px 0px;" type="checkbox" id="settings" > <span style="width:250px;margin-top:10px;margin-bottom:10px;display:block;size:100px"><font  size="6px" color="blue">安 全 传 输&nbsp&nbsp&nbsp&nbsp</font></span></div>
                <div class="settings" id="settings"><input style="background-color:#00CC66;height:40px;margin:10px 20px 10px 0px;" type="checkbox" id="settings" > <span style="width:250px;margin-top:10px;margin-bottom:10px;display:block;size:100px"><font  size="6px" color="blue">自 动 更 新&nbsp&nbsp&nbsp&nbsp</font></span></div>
                <div class="settings" id="settings"><input style="background-color:#00CC66;height:40px;margin:10px 20px 10px 0px;" type="checkbox" id="settings" > <span style="width:250px;margin-top:10px;margin-bottom:10px;display:block;size:100px"><font  size="6px" color="blue">定 时 备 份&nbsp&nbsp&nbsp&nbsp</font></span></div>
               </li>
            </ul>
