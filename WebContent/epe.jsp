...
<!--测试标准说明信息 -->
 	 <div style="text-align:left;margin:20px 10px;">
 		 ...
 		 <li>2. 只关注定屏/reboot问题： 定屏/reboot问题的平均时间不小于20小时，中值平均时间达到25小时;<br>
         第一次出现ANR/CRASH等异常的平均时间不小于12小时，中值平均时间不小于15小时）</li>
  		<li>3.EPE值标准:PTR1<0.0005；PTR2<0.0002；PTR3<0.0001</li>

  		<b>注：EPE值计算公式：EPE=所有问题数/（单次事件数×总循环数），即，EPE=所有问题数/(200000X10X有效设备数)</b>
  		</ul>
  	 </div>
